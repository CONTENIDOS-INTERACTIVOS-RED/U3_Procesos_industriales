        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde el enfoque de la ingeniería industrial moderna, la gestión y el control de procesos es una pieza clave para garantizar eficiencia, calidad y sostenibilidad en la producción. En esta unidad, se estudiarán herramientas como el Control Estadístico de Procesos (CEP), los sistemas SCADA, sensores IoT y estrategias de mantenimiento predictivo con Inteligencia Artificial, integradas a metodologías como Lean Manufacturing, Six Sigma y TPM. Estas temáticas permitirán al estudiante comprender cómo monitorear, evaluar y optimizar el desempeño industrial con criterios estratégicos, tecnológicos y sostenibles.
              
              p #[b ¡Prepárese para transformar los procesos industriales con visión analítica, tecnológica y sustentable!]
